...
function welcome() {
  app.innerHTML = `<section class="hero"><div><div class="eyebrow">FIND YOUR VISUAL TASTE</div><h1>あなたの「好き」を、<br>一枚のイラストへ。</h1><p class="intro">5回、キャラクターの絵を選ぶ。<br>見えてきた好みを、あなたの言葉で確かめる。<br>AIと一緒に、あなたらしい描き方を探しましょう。</p><button class="primary" id="start">体験をはじめる <span>↗</span></button><p class="note">約2〜3分 · 登録不要 · この端末の中で動作します</p><div class="welcome-small">${sampleControl()}</div>${cfg.ready ? "" : '<p class="note ready-note">画像を準備中です。準備完了後に体験できます。</p>'}</div><div class="hero-art"><img src="/assets/generic/cat-0.png" alt="窓辺で猫と過ごすキャラクターの生成画像"><div class="floating-note"><small>A LITTLE MORE YOU</small>柔らかな光。好きな色。あなたの一枚。</div><p class="image-caption">Illustrious XL v2.0 · キャラクターイラストの事前生成画像</p></div></section><div class="journey"><div><b>01</b><span>直感で選ぶ<small>5つの画像ペアから</small></span></div><div><b>02</b><span>解釈を直す<small>違っていたら、変えていい</small></span></div><div><b>03</b><span>並べて見つける<small>最後に選ぶのは、あなた</small></span></div>`;
