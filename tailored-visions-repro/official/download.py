...
def after_timeout():
    ...
    '''
    print("Time out!")
# [2026 patch] after_timeout() was *called* at decoration time, so importing
# this module printed a bogus 'Time out!' on every run, and the decorator
# stored None as the callback (TypeError on a real timeout).
