...
export OMINI_CONFIG="train/config/premier.yaml"
...
# 参数设置
MIN_FREE_MEMORY=70000   # 默认显存阈值40000
GPU_NUM=4
...
execute_func() {
  accelerate launch --main_process_port 10809 -m omini.train_flux.train_premier
